...
| Clenow Momentum | KR | 주봉 모멘텀 | 2015~ | 14.14% / **6.94%** | -19.2% | 0.94 / **0.59** | +0.45%p / +4.14%p | ⚠️ **폐기 검토** (컷오프 게이트 미달) |
...
**현재 (2026-05-18) 상태**:
- US 트랙 = Clenow + Weinstein 60:40 합성 실계좌 운영 중
- KR 트랙 = KW Super Value (분기 가치) 메인 엔진 확정, 페이퍼 진입 대기
- Clenow KR 폐기 검토 (컷오프 후 게이트 미달, Sharpe 0.59)
- 권장 글로벌 합성: **US Clenow 40% + KW SV 60%** (Sharpe 컷 1.33, Δ -0.06 robust)
...
- **글로벌 합성 비율 (최우선)** — 컷오프 분석 후 새 권장:
  - 보수: US 50 + KW SV 50 (Sharpe 컷 1.36)
  - **중간: US 40 + KW SV 60** ⭐ (Δ Sharpe -0.06, 매우 robust)
  - 공격: US 30 + KW SV 70 (CAGR 21.91%, MDD -29%)
- **Clenow KR 처분** — 폐기 vs 운영 유지 (컷오프 Sharpe 0.59 게이트 미달)
